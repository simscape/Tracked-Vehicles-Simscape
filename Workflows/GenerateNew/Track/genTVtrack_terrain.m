function [newContactTerrainFile, newContactTerrainSub] = genTVtrack_terrain(nSegs)

%% Source files: Copy to new location and modify
refContactTerrainFile = 'sm_trackV_lib_terrain_contact_s46';

% Reference subsystem to be modified
refContactTerrainSub_list  = {'CF Track Terrain s46','CF Track BrickBump s46'};
...
for si = 1:length(refContactTerrainSub_list)
    ...
    newContactTerrainSub = strrep(refContactTerrainSub,dpat{1},num2str(nSegs));
