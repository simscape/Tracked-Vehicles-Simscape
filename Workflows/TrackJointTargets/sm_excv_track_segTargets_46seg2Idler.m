function track_seg_tgts = sm_excv_track_segTargets_46seg2Idler(pin_sep, sprk_pitch_rad)
...
track_seg_tgts = {...
    ...
    'on'     'High'    qSegSpr*1.2
    'on'     'High'    qSegSpr*1.1  
    'on'     'High'    qSegSpr*0.75     
    'on'     'High'    qSegSpr*0      
    'on'     'High'    0 %qSegSpr*0.7
    'on'     'High'    0 %qSegSpr*0.9
    'on'     'High'    qSegSpr*0.0      
    'on'     'High'    0      
    'on'     'High'    0 %90-(2.5+0.1)*qSegSpr 
    'on'     'High'    0  
    'on'     'High'    0 %qSegSpr*0.2 
    'on'     'High'    0 %qSegSpr
    'on'     'High'    0 %qSegSpr 
    'on'     'High'    0 %qSegSpr 
    'on'     'High'    0 %qSegSpr 
    'on'     'High'     0 %qSegSpr*0.5 
    'on'     'Low'     0  
    'on'     'Low'     0 
    'on'     'Low'      qSegSpr*0  
    'off'     'Low'     qSegSpr*1.2 
