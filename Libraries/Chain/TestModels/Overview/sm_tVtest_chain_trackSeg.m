...
% 
% <<sm_tVtest_chain_trackSeg_Overview.png>>
%
...
% contact geometry.
%
% <matlab:open_system('sm_tVtest_chain_trackSeg'); Open Model>

open_system('sm_tVtest_chain_trackSeg')

set_param(find_system('sm_tVtest_chain_trackSeg','FindAll', 'on','type','annotation','Tag','ModelFeatures'),'Interpreter','off')
...
%
% <matlab:open_system('sm_tVtest_chain_trackSeg');open_system('sm_tVtest_chain_trackSeg/Track%20Segment%20Point%20Cloud%20All1','force'); Open Subsystem>

set_param('sm_tVtest_chain_trackSeg/Track Segment Point Cloud All1','LinkStatus','none')
open_system('sm_tVtest_chain_trackSeg/Track Segment Point Cloud All1','force')
...
%
% <matlab:open_system('sm_tVtest_chain_trackSeg');open_system('sm_tVtest_chain_trackSeg/Track%20Segment%20Plate%20Solid1','force'); Open Subsystem>

set_param('sm_tVtest_chain_trackSeg/Track Segment Plate Solid1','LinkStatus','none')
open_system('sm_tVtest_chain_trackSeg/Track Segment Plate Solid1','force')

%%

close all
bdclose('sm_tVtest_chain_trackSeg');
