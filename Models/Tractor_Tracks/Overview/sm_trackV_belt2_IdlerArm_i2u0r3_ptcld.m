%% Belt Track (Double), Ground Contact Point Cloud
% 
% <<sm_trackV_belt2_IdlerArm_i2u0r3_ptcld_terrain_Overview.png>>
%
...
% on the belt. The track can be tested on uneven terrain or a slope. The
...
%
% <matlab:open_system('sm_trackV_belt2_IdlerArm_i2u0r3_ptcld'); Open Model>

open_system('sm_trackV_belt2_IdlerArm_i2u0r3_ptcld')

set_param(find_system('sm_trackV_belt2_IdlerArm_i2u0r3_ptcld','FindAll', 'on','type','annotation','Tag','ModelFeatures'),'Interpreter','off')
...
%
% <matlab:open_system('sm_trackV_belt2_IdlerArm_i2u0r3_ptcld');open_system('sm_trackV_belt2_IdlerArm_i2u0r3_ptcld/Track%20L','force'); Open Subsystem>

set_param('sm_trackV_belt2_IdlerArm_i2u0r3_ptcld/Track L','LinkStatus','none')
open_system('sm_trackV_belt2_IdlerArm_i2u0r3_ptcld/Track L','force')
...
% the chain.
%
% <matlab:open_system('sm_trackV_belt2_IdlerArm_i2u0r3_ptcld');open_system('sm_trackV_belt2_IdlerArm_i2u0r3_ptcld/Track%20L/Undercarriage/Rollers','force'); Open Subsystem>

set_param('sm_trackV_belt2_IdlerArm_i2u0r3_ptcld/Track L/Undercarriage','LinkStatus','none')
set_param('sm_trackV_belt2_IdlerArm_i2u0r3_ptcld/Track L/Undercarriage/Rollers','LinkStatus','none')
open_system('sm_trackV_belt2_IdlerArm_i2u0r3_ptcld/Track L/Undercarriage/Rollers','force')
...
%
% <matlab:open_system('sm_trackV_belt2_IdlerArm_i2u0r3_ptcld');open_system('sm_trackV_belt2_IdlerArm_i2u0r3_ptcld/Track%20L/Track','force'); Open Subsystem>

set_param('sm_trackV_belt2_IdlerArm_i2u0r3_ptcld/Track L/Track','LinkStatus','none')
open_system('sm_trackV_belt2_IdlerArm_i2u0r3_ptcld/Track L/Track','force')
...
%
%
% <matlab:open_system('sm_trackV_belt2_IdlerArm_i2u0r3_ptcld');open_system('sm_trackV_belt2_IdlerArm_i2u0r3_ptcld/Track%20L/Track/Seg%2001','force'); Open Subsystem>

set_param('sm_trackV_belt2_IdlerArm_i2u0r3_ptcld/Track L/Track/Seg 01','LinkStatus','none')
open_system('sm_trackV_belt2_IdlerArm_i2u0r3_ptcld/Track L/Track/Seg 01','force')
...
%
% For ground contact, points are distributed across the carcass face.  

stl_to_gridsurface('hills_terrain.stl',100,100,'plot');

set_param('sm_trackV_belt2_IdlerArm_i2u0r3_ptcld/Scene','LabelModeActiveChoice','Terrain');
...
sim('sm_trackV_belt2_IdlerArm_i2u0r3_ptcld');

sm_excv_track_plot1loc(simlog_sm_trackV_belt2_IdlerArm_i2u0r3_ptcld,logsout_sm_trackV_belt2_IdlerArm_i2u0r3_ptcld);
sm_excv_track_plot2trq(simlog_sm_trackV_belt2_IdlerArm_i2u0r3_ptcld);
sm_excv_track_plot3fcroller(logsout_sm_trackV_belt2_IdlerArm_i2u0r3_ptcld,'magnitude');
...
set_param('sm_trackV_belt2_IdlerArm_i2u0r3_ptcld/Track Speeds','LabelModeActiveChoice','None')
set_param('sm_trackV_belt2_IdlerArm_i2u0r3_ptcld/Scene',       'LabelModeActiveChoice','Slope');
set_param('sm_trackV_belt2_IdlerArm_i2u0r3_ptcld/Track L','popup_sense_roller','Constraint Force')
set_param('sm_trackV_belt2_IdlerArm_i2u0r3_ptcld/Track R','popup_sense_roller','Constraint Force')
sim('sm_trackV_belt2_IdlerArm_i2u0r3_ptcld');
set_param('sm_trackV_belt2_IdlerArm_i2u0r3_ptcld/Track L','popup_sense_roller','Actuator Torque')
set_param('sm_trackV_belt2_IdlerArm_i2u0r3_ptcld/Track R','popup_sense_roller','Actuator Torque')

fcR = sm_excv_track_plot3fcroller(logsout_sm_trackV_belt2_IdlerArm_i2u0r3_ptcld,'vertical');
close(gcf)
sm_excv_track_plot5fcrollerFinal('sm_trackV_belt2_IdlerArm_i2u0r3_ptcld', fcR);


%%

close all
%bdclose('sm_trackV_belt2_IdlerArm_i2u0r3_ptcld');
