%% Excavator Tracks, Ground Contact Point Cloud
% 
% <<sm_excv_track2_ptcld_Overview.png>>
%
...
%
% <matlab:open_system('sm_excv_track2_ptcld'); Open Model>

open_system('sm_excv_track2_ptcld')

set_param(find_system('sm_excv_track2_ptcld','FindAll', 'on','type','annotation','Tag','ModelFeatures'),'Interpreter','off')
...
%
% <matlab:open_system('sm_excv_track2_ptcld');open_system('sm_excv_track2_ptcld/Track%20L','force'); Open Subsystem>

set_param('sm_excv_track2_ptcld/Track L','LinkStatus','none')
open_system('sm_excv_track2_ptcld/Track L','force')
...
% the chain.
%
% <matlab:open_system('sm_excv_track2_ptcld');open_system('sm_excv_track2_ptcld/Track%20L/Undercarriage/Rollers','force'); Open Subsystem>

set_param('sm_excv_track2_ptcld/Track L/Undercarriage','LinkStatus','none')
set_param('sm_excv_track2_ptcld/Track L/Undercarriage/Rollers','LinkStatus','none')
open_system('sm_excv_track2_ptcld/Track L/Undercarriage/Rollers','force')
...
%
% <matlab:open_system('sm_excv_track2_ptcld');open_system('sm_excv_track2_ptcld/Track%20L/Track','force'); Open Subsystem>

set_param('sm_excv_track2_ptcld/Track L/Track','LinkStatus','none')
open_system('sm_excv_track2_ptcld/Track L/Track','force')
...
%
% <matlab:open_system('sm_excv_track2_ptcld');open_system('sm_excv_track2_ptcld/Track%20L/Track/Seg%2001','force'); Open Subsystem>

set_param('sm_excv_track2_ptcld/Track L/Track/Seg 01','LinkStatus','none')
open_system('sm_excv_track2_ptcld/Track L/Track/Seg 01','force')
...
sm_excv_track_plot3fcroller(logsout_sm_excv_track2_ptcld,'magnitude');
...
set_param('sm_excv_track2_ptcld/Track Speeds','LabelModeActiveChoice','None')
set_param('sm_excv_track2_ptcld/Scene',       'LabelModeActiveChoice','Road');
set_param('sm_excv_track2_ptcld/Track L','popup_sense_roller','Constraint Force')
set_param('sm_excv_track2_ptcld/Track R','popup_sense_roller','Constraint Force')
sim('sm_excv_track2_ptcld')
set_param('sm_excv_track2_ptcld/Track L','popup_sense_roller','Actuator Torque')
set_param('sm_excv_track2_ptcld/Track R','popup_sense_roller','Actuator Torque');

fcR = sm_excv_track_plot3fcroller(logsout_sm_excv_track2_ptcld,'vertical');
close(gcf)
sm_excv_track_plot5fcrollerFinal('sm_excv_track2_ptcld', fcR);

%%

close all
bdclose('sm_excv_track2_ptcld');
