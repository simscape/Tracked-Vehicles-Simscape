...
% 
% <<sm_excv_track1_float_Overview.png>>
%
...
%
% <matlab:open_system('sm_excv_track1_float'); Open Model>


open_system('sm_excv_track1_float')

set_param(find_system('sm_excv_track1_float','FindAll', 'on','type','annotation','Tag','ModelFeatures'),'Interpreter','off')
...
%
% <matlab:open_system('sm_excv_track1_float');open_system('sm_excv_track1_float/Track%20L','force'); Open Subsystem>

set_param('sm_excv_track1_float/Track L','LinkStatus','none')
open_system('sm_excv_track1_float/Track L','force')
...
% the chain.
%
% <matlab:open_system('sm_excv_track1_float');open_system('sm_excv_track1_float/Track%20L/Undercarriage/Rollers','force'); Open Subsystem>

set_param('sm_excv_track1_float/Track L/Undercarriage','LinkStatus','none')
set_param('sm_excv_track1_float/Track L/Undercarriage/Rollers','LinkStatus','none')
open_system('sm_excv_track1_float/Track L/Undercarriage/Rollers','force')
...
%
% <matlab:open_system('sm_excv_track1_float');open_system('sm_excv_track1_float/Track%20L/Track','force'); Open Subsystem>

set_param('sm_excv_track1_float/Track L/Track','LinkStatus','none')
open_system('sm_excv_track1_float/Track L/Track','force')
...
%
% <matlab:open_system('sm_excv_track1_float');open_system('sm_excv_track1_float/Track%20L/Track/Seg%2001','force'); Open Subsystem>

set_param('sm_excv_track1_float/Track L/Track/Seg 01','LinkStatus','none')
open_system('sm_excv_track1_float/Track L/Track/Seg 01','force')
...
sim('sm_excv_track1_float');

sm_excv_track_plot2trq(simlog_sm_excv_track1_float);

%%

close all
bdclose('sm_excv_track1_float');
