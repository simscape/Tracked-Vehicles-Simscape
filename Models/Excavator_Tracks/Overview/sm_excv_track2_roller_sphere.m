...
% 
% <<sm_excv_track2_roller_sphere_Overview.png>>
%
% (<matlab:web('Tracked_Vehicle_Simscape_Overview.html') return to Tracked Vehicle Model with Simscape Overview>)
%
% This example models the track drive from an excavator in an abstract
...
%
% <matlab:open_system('sm_excv_track2_roller_sphere'); Open Model>

open_system('sm_excv_track2_roller_sphere')

set_param(find_system('sm_excv_track2_roller_sphere','FindAll', 'on','type','annotation','Tag','ModelFeatures'),'Interpreter','off')
...
% contact.
% 
% <matlab:open_system('sm_excv_track2_roller_sphere');open_system('sm_excv_track2_roller_sphere/Track%20L','force'); Open Subsystem>

set_param('sm_excv_track2_roller_sphere/Track L','LinkStatus','none')
open_system('sm_excv_track2_roller_sphere/Track L','force')
...
%
% <matlab:open_system('sm_excv_track2_roller_sphere');open_system('sm_excv_track2_roller_sphere/Track%20L/Undercarriage/Rollers','force'); Open Subsystem>

set_param('sm_excv_track2_roller_sphere/Track L/Undercarriage','LinkStatus','none')
set_param('sm_excv_track2_roller_sphere/Track L/Undercarriage/Rollers','LinkStatus','none')
open_system('sm_excv_track2_roller_sphere/Track L/Undercarriage/Rollers','force')
...
% the track.
%
% <matlab:open_system('sm_excv_track2_roller_sphere');open_system('sm_excv_track2_roller_sphere/Track%20L/Undercarriage/Rollers/Roller%20Lower%201','force'); Open Subsystem>

set_param('sm_excv_track2_roller_sphere/Track L/Undercarriage/Rollers/Roller Lower 1','LinkStatus','none')
open_system('sm_excv_track2_roller_sphere/Track L/Undercarriage/Rollers/Roller Lower 1','force')
...
% segments.
%
% <matlab:open_system('sm_excv_track2_roller_sphere');open_system('sm_excv_track2_roller_sphere/Track%20L/Track','force'); Open Subsystem>

set_param('sm_excv_track2_roller_sphere/Track L/Track','LinkStatus','none')
open_system('sm_excv_track2_roller_sphere/Track L/Track','force')
...
close all
bdclose('sm_excv_track2_roller_sphere');
