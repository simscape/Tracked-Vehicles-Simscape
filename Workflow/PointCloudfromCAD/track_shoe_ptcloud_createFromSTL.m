function [ptcld_grousers, ptcld_plate] = track_shoe_ptcloud_createFromSTL(stlfilename,varargin)
%track_shoe_ptcloud_createFromSTEP Produce point cloud data from track shoe STL file.
...
%
%  [ptcld_grousers, ptcld_plate] = track_shoe_ptcloud_createFromSTEP('CAD_Track_Shoe.STL');
